<%@ Page Language="C#" AutoEventWireup="true" Async="true" EnableEventValidation="false" CodeFile="Default.aspx.cs" Inherits="_Default" %>
						...
						<ul class="nav-user navbar-right">
							<li class="dropdown">
							  <a href="#fakelink" class="dropdown-toggle" data-toggle="dropdown">
								...
								Hi, <strong ><asp:Label ID="lblusername" runat="server"></asp:Label></strong>
							  </a>
							  <ul class="dropdown-menu square primary margin-list-rounded with-triangle">
								...
								<li><a href="#" onserverclick="Log_out" runat="server">Log out</a></li>
							  </ul>
							</li>
						</ul>
